...
const Card = () => {
    return (
        <div class="max-w-max w-full lg:max-w-full lg:flex">
            ...
            <div
                className="border-r border-b border-l border-violet-400 rounded-l-lg lg:border-t lg:border-violet-400 bg-violet-800 rounded-b-lg lg:rounded-r-lg p-4 flex flex-col justify-between leading-normal">
                ...
                <div>
                    ...
                    <p className="text-xs italic text-center mt-0">(Scroll to bottom for full playlist)</p>
                </div>
                <div className="mb-8">
